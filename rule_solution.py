...
def extract_features(train_df, test_df):
    ...
    flights_df_60.rename(columns={'flight_ID':"flightNum_60"}, inplace = True)
    ...
    flights_df_50.rename(columns={'flight_ID': "flightNum_50"}, inplace=True)
    ...
    flights_df_40.rename(columns={'flight_ID': "flightNum_40"}, inplace=True)
    ...
    flights_df_30.rename(columns={'flight_ID': "flightNum_30"}, inplace=True)
    ...
    flights_df_20.rename(columns={'flight_ID': "flightNum_20"}, inplace=True)
    ...
    flights_df_10.rename(columns={'flight_ID': "flightNum_10"}, inplace=True)
